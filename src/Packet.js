...
function Packet(universe, priority, cid, source){
	...
	this._priority = 100;
	this._slots = [];
	this._cid = Buffer.from([0x29, 0x97, 0x97, 0x45, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
...
Packet.prototype.update = function(){
	...
	this._buffer = Buffer.concat([this._rootLayer, this._framingLayer, this._DMPLayer, Buffer.from(this._slots)]);
}
